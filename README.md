...
🚀 **MERN Stack Developer | SaaS Builder | Generative AI Enthusiast**  

💡 Self-driven developer with 1+ year of experience in **frontend + backend development**, building **scalable SaaS products** using the MERN stack.  
I love turning innovative ideas into functional, user-centered web applications.
...
### 💼 Work Experience
- 🏥 **MediVolt** – MERN Stack Developer *(Sep 2025 – Present)*  
  Working on SaaS-based healthcare platforms and backend integrations.  

- 🦄 **Unicorn Tech** – MERN Stack Developer *(May 2025 – Jul 2025)*  
  Built responsive dashboards and enhanced UX using React & Figma.  

- 💻 **Hind Tech Learning Point** – Full Stack Developer *(Oct 2024 – Apr 2025)*  
  Delivered 10+ production-ready full-stack apps using MERN stack.  

- ⚡ **Bijli Wala Aaya** – Full Stack Developer *(Jul 2025 – Aug 2025)*  
  Integrated Firebase backend, Google Auth & Razorpay payment systems.
...
### 🏆 Certifications
📜 **2-Day Generative AI Masterclass – Outscal (Nov 2025)**  
📜 **MERN Stack Developer – Hind Tech Learning Point (2024)**  
...
> 💬 *“Code. Learn. Build. Repeat.” — Every line brings you closer to mastery.*  
